...
class QwenVLChatBot:
    def __init__(self, base_model_path, lora_ckpt_path):
        print("加载模型中...")
...
if __name__ == "__main__":
    bot = QwenVLChatBot(
        ...
        lora_ckpt_path="/data5/zhangenwei/Datasets/Output/coco_2014/checkpoint-62"
    )
